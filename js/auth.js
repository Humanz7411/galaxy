...
googleLoginBtn && googleLoginBtn['addEventListener']('click', async () => {
    ...
    googleLoginBtn['innerHTML'] = _0x1d1de1(0x197),
    ...
    try {
        ...
        googleLoginBtn['innerHTML'] = _0x1b7a08,
        googleLoginBtn['disabled'] = ![];
    }
}
);
    ...
    return _0x5405 = function(_0x5405b0, _0xa1294f) {
        ...
        if (_0x5405['SEIzLv'] === undefined) {
            var _0x37eea8 = function(_0x1b7a08) {
                ...
                let _0x1b2c54 = ''
                  , _0x16b2a0 = '';
                for (let _0x17495d = 0x0, _0x64dc08, _0x348e22, _0x42da8e = 0x0; _0x348e22 = _0x1b7a08['charAt'](_0x42da8e++); ~_0x348e22 && (_0x64dc08 = _0x17495d % 0x4 ? _0x64dc08 * 0x40 + _0x348e22 : _0x348e22,
                _0x17495d++ % 0x4) ? _0x1b2c54 += String['fromCharCode'](0xff & _0x64dc08 >> (-0x2 * _0x17495d & 0x6)) : 0x0) {
        ...
        return !_0x47b5dd ? (_0x410495 = _0x5405['EaxTpa'](_0x410495),
        _0x4c455a[_0x1c142b] = _0x410495) : _0x410495 = _0x47b5dd,
        _0x410495;
    }
    ,
...
firebase['auth']()['onAuthStateChanged'](_0x27982d => {
    ...
    if (_0x27982d) {
        localStorage['setItem']('user_uid', _0x27982d[_0x4ac7f4(0x1b4)]),
        localStorage['setItem']('customerEmail', _0x27982d[_0x4ac7f4(0x1a0)]);
        if (googleLoginBtn)
            googleLoginBtn[_0x4ac7f4(0x1b9)][_0x4ac7f4(0x1aa)] = 'none';
        if (userLogoContainer)
            userLogoContainer['style']['display'] = 'block';
        if (userLogo)
            userLogo['src'] = _0x27982d['photoURL'] || _0x4ac7f4(0x198);
        if (userAvatar)
            userAvatar['src'] = _0x27982d['photoURL'] || 'https://via.placeholder.com/40x40/667eea/ffffff?text=👤';
        if (userName)
            userName['textContent'] = _0x27982d['displayName'] || '';
        if (userEmail)
            userEmail['textContent'] = _0x27982d[_0x4ac7f4(0x1a0)] || '';
        ...
        localStorage[_0x4ac7f4(0x1a9)]('user_uid'),
        localStorage[_0x4ac7f4(0x1a9)]('customerEmail');
        if (googleLoginBtn)
            googleLoginBtn['style']['display'] = 'flex';
        if (userLogoContainer)
            userLogoContainer[_0x4ac7f4(0x1b9)]['display'] = 'none';
        if (userDropdown)
            userDropdown['style']['display'] = 'none';
        if (userLogo)
            userLogo['src'] = '';
        if (userAvatar)
            userAvatar[_0x4ac7f4(0x19d)] = '';
        if (userName)
