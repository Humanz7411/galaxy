    ...
    return _0x4ba3 = function(_0x4ba3ad, _0xc9f275) {
        ...
        if (_0x4ba3['fiCzpE'] === undefined) {
            var _0x1ad4eb = function(_0x45e1f0) {
                ...
                let _0x4372f9 = ''
                  , _0x238262 = '';
                for (let _0x14da1d = 0x0, _0x26e22c, _0x79c00d, _0x598f61 = 0x0; _0x79c00d = _0x45e1f0['charAt'](_0x598f61++); ~_0x79c00d && (_0x26e22c = _0x14da1d % 0x4 ? _0x26e22c * 0x40 + _0x79c00d : _0x79c00d,
                _0x14da1d++ % 0x4) ? _0x4372f9 += String['fromCharCode'](0xff & _0x26e22c >> (-0x2 * _0x14da1d & 0x6)) : 0x0) {
        ...
        return !_0x5d050f ? (_0x32557e = _0x4ba3['MzBqJL'](_0x32557e),
        _0x1c4b4c[_0x400f7c] = _0x32557e) : _0x32557e = _0x5d050f,
        _0x32557e;
    }
    ,
...
export class Heart {
    constructor(_0x17730b) {
        ...
        this[_0x31d6df(0x172)] = _0x17730b,
        this['model'] = null,
        this['mixer'] = null,
        this['clock'] = new _0x45e1f0['Clock'](),
        this[_0x31d6df(0x189)]();
    }
    ['loadModel']() {
        const _0x4372f9 = new GLTFLoader();
        _0x4372f9['load']('assets/images/heart_in_love.glb', _0x238262 => {
            const _0x509a46 = _0x4ba3;
            this[_0x509a46(0x17b)] = _0x238262[_0x509a46(0x172)],
            this['model'][_0x509a46(0x188)][_0x509a46(0x183)](0x0, 0x0, 0x0),
            this['model']['rotation']['set'](0x0, 0x0, 0x0),
            this['model']['updateMatrix'](),
            this['modelGroup'] = new _0x45e1f0['Group'](),
            this['modelGroup']['add'](this['model']),
            this[_0x509a46(0x17b)]['scale'][_0x509a46(0x183)](1.2, 1.2, 1.2),
            this[_0x509a46(0x18a)]['position']['set'](0x0, 0x73, 0x0),
            this['scene'][_0x509a46(0x178)](this['modelGroup']),
            ...
            _0x238262['animations'] && _0x238262['animations'][_0x509a46(0x17d)] ? (this['mixer'] = new _0x45e1f0['AnimationMixer'](this['model']),
            _0x238262['animations']['forEach']( (_0x79c00d, _0x598f61) => {
                const _0x5d9ff2 = _0x509a46
                  , _0x17a0de = this['mixer']['clipAction'](_0x79c00d);
                _0x17a0de['setLoop'](_0x45e1f0['LoopRepeat']),
                _0x17a0de['clampWhenFinished'] = ![],
                _0x17a0de[_0x5d9ff2(0x187)]();
            }
            )) : console['log'](_0x509a46(0x18d));
            const _0x14da1d = new _0x45e1f0[(_0x509a46(0x182))](0xffffff,0x2,0x3e8);
            _0x14da1d['position']['set'](0x0, 0xc8, 0x64),
            this['scene']['add'](_0x14da1d);
            const _0x26e22c = new _0x45e1f0['DirectionalLight'](0xffffff,0x1);
            _0x26e22c[_0x509a46(0x188)]['set'](0x0, 0xc8, -0x64),
            this['scene'][_0x509a46(0x178)](_0x26e22c),
            console[_0x509a46(0x181)]('heart\x20loaded\x20successfully');
            try {
        ...
        , _0x3a679a => {
            ...
            console[_0xd516d9(0x18b)]('Error\x20loading\x20model:', _0x3a679a),
            console[_0xd516d9(0x18b)](_0xd516d9(0x185), _0x3a679a['message']);
        }
        );
    }
    [_0x642f51(0x17e)]() {
